...
const Item = () => {
  ...
  useEffect(() => {
    i
      ? (document.title = `${i.name[0].toUpperCase()}${i.name.substring(
          1,
          i.name.length
        )}`)
          ...
          <div className={styles.info}>
            ...
            <div className={styles.item__btns}>
              ...
              <button className={styles.item__card}>
                ...
                доставка по Какчетаву и области
              </button>
              <button
                className={`${styles.item__card} ${styles.item__download}`}
              >
